...
@section('seo_title', __('Blog Categories'))
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Blog Categories')</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('All Blog Categories')</h3>
                        <div class="card-tools">
                            <form style="display:none;" id="change-priority-form" class="btn-group" action="{{route('admin.blog_categories.change_priorities')}}" method="post">
                                @csrf
                            ...
                            <a href="{{route('admin.blog_categories.add')}}" class="btn btn-success">
                        ...
                        <table id="entities-list-table" class="table table-bordered">
                            ...
                            <tbody id="sortable-list">
                                ...
                                <tr data-id="{{$blogCategory->id}}">
                                    ...
                                    <td>
                                        {{\Str::limit($blogCategory->description, 50)}}
                                    </td>
                                    <td class="text-center">{{$blogCategory->created_at}}</td>
                                    <td class="text-center">{{$blogCategory->updated_at}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('admin.blog_categories.edit', ['blogCategory' => $blogCategory->id])}}" class="btn btn-info">
...
<form class="modal fade" id="delete-modal" action="{{route('admin.blog_categories.delete')}}" method="post">
    @csrf
